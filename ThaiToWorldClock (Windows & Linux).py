...
try:
    #Ding sound when using windows
    from winsound import PlaySound, SND_FILENAME
except ImportError:
    pass

#Test If OSX or Not, if OSX won't run.
try:
    import Carbon
except ImportError:
    ...
    import tkMessageBox
    tkMessageBox.showerror("Compatible Error", "Your system is not supported for this application, please try again on Windows or Linux Ubuntu.")
